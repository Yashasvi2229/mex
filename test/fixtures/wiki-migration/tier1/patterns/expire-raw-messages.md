---
name: expire-raw-messages
description: "Expire raw messages past their retention window. Follow this rather than working it out again."
triggers:
  - "retention"
  - "expiry"
edges:
...
---
# Expire raw messages past their retention window
