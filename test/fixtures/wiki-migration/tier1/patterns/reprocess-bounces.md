---
name: reprocess-bounces
description: "Reprocess a batch of bounced replies. Follow this rather than working it out again."
triggers:
  - "bounce"
  - "reprocess"
edges:
...
---
# Reprocess a batch of bounced replies
