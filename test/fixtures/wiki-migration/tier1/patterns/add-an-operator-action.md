---
name: add-an-operator-action
description: "Add an action operators can take on a ticket. Follow this rather than working it out again."
triggers:
  - "operator"
  - "action"
edges:
...
---
# Add an action operators can take on a ticket
