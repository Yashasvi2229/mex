---
name: rotate-provider-credentials
description: "Rotate the mail provider credentials. Follow this rather than working it out again."
triggers:
  - "credentials"
  - "rotation"
edges:
...
---
# Rotate the mail provider credentials
