...
try {
  ...
  if (currentPackage.version !== LOCKED_VERSION || basePackage.version !== LOCKED_VERSION) {
    throw new Error(`package version must remain ${LOCKED_VERSION}.`);
  }
